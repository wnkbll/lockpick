...
--filter-tcp=443 --hostlist="../../list-general.txt" --dpi-desync=fake,split2 --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls="../bin/tls_clienthello_www_google_com.bin" --new ^
...
net stop "%SRVCNAME%"
sc delete "%SRVCNAME%"
sc create "%SRVCNAME%" binPath= "\..\..\x86_64\winws.exe\" %ARGS%" DisplayName= "zapret DPI bypass : winws1" start= auto
